defmodule ExLokaliseTransfer.Integration.DownloaderSyncTest do
  ...
  setup do
    ...
    if blank?(api_token) or blank?(project_id) do
      ...
      original_downloader_sync_module =
        Application.get_env(:ex_lokalise_transfer, :downloader_sync_module)
      ...
      Application.delete_env(:ex_lokalise_transfer, :downloader_sync_module)
  ...
  test "downloads and extracts Lokalise bundle synchronously", %{project_id: project_id} do
    extract_to = make_tmp_dir!("downloader_sync_integration")
    ...
    assert :ok =
             ExLokaliseTransfer.download_sync(
